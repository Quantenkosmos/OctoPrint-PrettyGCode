...
class PrettyGCodePlugin(octoprint.plugin.StartupPlugin,
    ...
    def get_template_configs(self):
        return [
            dict(type="tab", template="prettygcode_tab.jinja2"),
            dict(type="navbar", template="prettygcode_navbar.jinja2")
        ]

    def get_assets(self):
        return dict(
            js=["js/prettygcode_patched.js","js/three.min.js",
                "js/LineSegmentsGeometry.js","js/LineGeometry.js","js/OBJLoader.js",
                "js/LineMaterial.js","js/LineSegments2.js","js/Line2.js","js/camera-controls_patched.js","js/Lut.js","js/dat.gui.js"],
